...
class _detail_produk_viewState extends State<detail_produk_view> {
  ...
  void setdata() async {
    ...
    brand_laptop.text = prefs.getString('brand').toString();
    processor_laptop.text = prefs.getString('processor').toString();
    ram_laptop.text = prefs.getString('ram').toString();
    vga_laptop.text = prefs.getString('vga').toString();
    hardisk_laptop.text = prefs.getString('hardisk').toString();
    harga_laptop.text = prefs.getString('harga').toString();
  }
